...
Result        </h2>
      ...
      <Search />
        <AdjustmentsIcon class="h-5 w-5    border-black rounded-md w-7 h-7	 "/>
   ...
   <div class="flex flex-col">
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        ...
        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <img src="src\assets\undraw_page_not_found_re_e9o6.svg" v-if="false" alt="">
      ...
      <div class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6 mb-10">

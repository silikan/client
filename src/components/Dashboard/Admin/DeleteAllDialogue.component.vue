...
console.log(type.value);
    ...
    const deleteAllGigs = () => {
      store.dispatch("Admin/deleteAllGigs");
      open.value = false;
    };
    const deleteAllClientRequests = () => {
      store.dispatch("Admin/deleteAllClientRequests");
    };
    const deleteAll = () => {
      store.dispatch("Admin/deleteAll");
    };
    let closeDiag = () => {
      open.value = false;
    };

...
const navigation = [
  {
    name: "Home",
    link: "/dashboard/moderator/home",
    icon: HomeIcon,
    current: true,
  },
  {
    name: "Transactions",
    link: "/dashboard/moderator/transactions",
    icon: CreditCardIcon,
    current: false,
  },
  {
    ...
    link: "/dashboard/moderator/feedback",
    icon: QuestionMarkCircleIcon,
    current: false,
  }
];
const secondaryNavigation = [
  { name: "Settings", link: "/dashboard/moderator/settings", icon: CogIcon },
];
const cards = [

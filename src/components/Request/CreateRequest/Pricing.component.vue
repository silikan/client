              ...
              <input
                ...
                :class="[
                  priceErrorMessage
                    ...
                    : ' block w-full pr-12  pl-7 px-3 py-2 border border-gray-300 rounded-md  -smplaceholder-gray-400 focus:outline-nonefocus:ring-indigo-500 focus:border-indigo-500 sm:text-sm',
                ]"
                placeholder="0.00"
...
export default {
  ...
  setup() {
    ...
    const { value: duration, errorMessage: durationErrorMessage } = useField(
      "duration",
      durationValidation
    );

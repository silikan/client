      ...
      <div class="relative sm:py-16 lg:py-0">
        ...
        <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
          ...
          <div class="relative pt-64 pb-10 rounded-2xl shadow-xl overflow-hidden">
            <img class="absolute inset-0 h-full w-full object-cover" src="../assets/Testemonials/kamel.jpg" alt="" />
            ...
            <div class="relative px-8">
              ...
              reliable and efficient services, I'm happy to use this site to find the best service provider near me, especially the massage.
                ...
                <footer class="mt-4">
                  <p class="text-base font-semibold text-indigo-200">Kamel Cerbah, CTO at silikan</p>
                </footer>
              </blockquote>
            </div>
          </div>

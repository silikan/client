...
export default {
  setup() {
    ...
    let timeline = ref([]);
    store
      .dispatch("Task/getTaskItemById", payload)
      .then((result) => {
        console.log(result.task_item);

        timeline.value = [
          {
            id: 1,
            content: "Client Added The Gig To Cart",
            status: "pending",
            handyman: result.handyman,
            client: result.client,

            condition: result.task_item.is_pending,
            icon: UserIcon,
            iconBackground: "bg-gray-400",
          },
          {
            id: 2,
            content: "Handyman Accepted The Gig",
            status: "accepted",
            handyman: result.handyman,
            client: result.client,

            condition: result.task_item.is_accepted,
            icon: ThumbUpIcon,
          ...
          },
          {
            ...
            condition: result.task_item.is_in_progress,
            icon: FlagIcon,
          ...
          },
          {
            ...
            condition: result.task_item.is_completed,
            icon: CheckIcon,
            iconBackground: "bg-green-500",
          },
          ...
          {
            id: 5,
            content: "Handyman Declined The Gig",
            status: "declined",
            handyman: result.handyman,
            client: result.client,

            condition: result.task_item.is_declined,
            icon: BanIcon,
...

          {
            ...
            condition: result.task_item.is_cancelled,
